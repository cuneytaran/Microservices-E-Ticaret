...
namespace FreeCourse.Web.Controllers
{
    ...
    [Authorize]//sadece üye olanlar istek yapabilir
    public class BasketController : Controller
    {
        //Catalog dediğimiz. bizim kurslarımız.
        ...
        public async Task<IActionResult> ApplyDiscount(DiscountApplyInput discountApplyInput)
        {
            ...
            {
                TempData["discountError"] = ModelState.Values.SelectMany(x => x.Errors).Select(x => x.ErrorMessage).First();//bir requestten diğer requeste data taşıma.
                return RedirectToAction(nameof(Index));
            }
