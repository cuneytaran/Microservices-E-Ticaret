...
namespace FreeCourse.Web.Controllers
{
    ...
    public class CoursesController : Controller
    {
        ...
        private readonly ISharedIdentityService _sharedIdentityService;//kullanıcı id sini almak için. token içinden çekeceğiz.
        //startupda tanıtmayı unutma!
        ...
        {
            return View(await _catalogService.GetAllCourseByUserIdAsync(_sharedIdentityService.GetUserId));//_sharedIdentityService.GetUserId) bu şekilde tek seferde userid sini dönebiliriz.
        }
