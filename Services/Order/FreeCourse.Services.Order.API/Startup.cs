...
namespace FreeCourse.Services.Order.API
{
    public class Startup
    {
        ...
        //Nudget packages den Microsoft.EntityFrameworkCore.Design yükle migration iþlemi için 
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddMassTransit(x =>
            {
                ...
                x.UsingRabbitMq((context, cfg) =>
                {
                    ...
                    cfg.ReceiveEndpoint("create-order-service", e =>//rabbitmq da kuyruðun adresini belirliyoruz
                    {
                        e.ConfigureConsumer<CreateOrderMessageCommandConsumer>(context);
                    });
                    cfg.ReceiveEndpoint("course-name-changed-event-order-service", e =>//ikinci rabbitmq nun adresini belirliyoruz
                    {
