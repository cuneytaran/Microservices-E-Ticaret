...
namespace FreeCourse.Services.Order.Application.Handlers
{
    ...
    public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand, Response<CreatedOrderDto>>//IRequestHandler mediatR den miral alıyor
    {
        ...
        //****veritanına gidip sorguların alınacağı bölüm.****
